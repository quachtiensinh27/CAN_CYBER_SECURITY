...
git clone https://github.com/quachtiensinh27/CAN_CYBER_SECURITY.git
cd CAN_CYBER_SECURITY

3. Nạp firmware STM32

Mở STM32CubeIDE.

Import project trong Firmware/STM32_CAN_Attack và Firmware/STM32_CAN_Defense

Cắm 2 board STM32F103C8T6

Build và nạp lần lượt.
...
Sau đó mở http://localhost:5000 trong browser.

5. Tương tác với hệ thống

Chọn COM port trong giao diện.

Nhấn "Gửi Spam" hoặc "Replay".

Quan sát log UART hoặc màn hình Web.
---
